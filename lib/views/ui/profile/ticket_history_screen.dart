...
class TicketHistoryScreen extends StatefulWidget {
  ...
  const TicketHistoryScreen({super.key, required this.dateTime});
...
class _TicketHistoryScreenState extends State<TicketHistoryScreen> {
  var formatter = new DateFormat.yMMMMEEEEd().format(DateTime.now());
    ...
    return Scaffold(
      backgroundColor: AppColors.white,
        appBar: AppBar(
            ...
            centerTitle: true,
            title: TitleText(title: "Ticket History", color: AppColors.titleColor, fontSize: width < 325
                ? Dimensions.font18
                : width < 375
                ? Dimensions.font20
            ...
            children: [
              SizedBox(
                ...
                child: ListView.builder(
                    itemCount: historyNotifier.his.length,
                    padding: EdgeInsets.only(top: Dimensions.height20),
                    itemBuilder: (context, index){
                      final country = historyNotifier.his[index];
                                ...
                                endActionPane: ActionPane(
                                  ...
                                  children: [
                                    SlidableAction(
                                      ...
                                      onPressed: (context){
                                        setState(() {
                                          historyNotifier.histories.removeWhere((element) => element == country["id"]);
